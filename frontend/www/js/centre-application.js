document.addEventListener('DOMContentLoaded', () => {
  const screens = [
    ...
    ['Terrain','Nouvelle capture','gestion-captures.html','add_circle','Enregistrer une collecte',['captures:creer']],
    ['Terrain','Sites sentinelles','gestion-sites.html','place','Implantations et activités',['sites:voir']],
    ['Terrain','Nouveau site','gestion-sites.html','add_location_alt','Créer une implantation',['sites:creer']],
    ['Terrain','Interventions','interventions.html','health_and_safety','Actions de lutte vectorielle',['interventions:gestion']],
    ['Terrain','Nouvelle intervention','interventions.html','medical_services','Programmer une action',['interventions:gestion']],
    ['Terrain','Campagnes','campagnes.html','campaign','Planification opérationnelle',['campagnes:gestion']],
    ['Terrain','Nouvelle campagne','campagnes.html','event_available','Créer une campagne',['campagnes:gestion']],
    ['Données','Datasets et annotations','gestion-datasets.html','dataset','Jeux de données ML',['datasets:gestion']],
    ['Données','Nouveau dataset','gestion-datasets.html','create_new_folder','Préparer un jeu de données',['datasets:gestion']],
    ...
    ['Administration','Nouvel utilisateur','gestion-utilisateurs.html','person_add','Créer un compte',['users:creer']],
  ...
  // PermissionGuard est injecté de façon asynchrone par core.js — on attend
  // qu'il soit prêt avant de calculer la liste, sinon rien n'est filtré (bug
  // constaté : tous les écrans étaient visibles quel que soit le rôle).
  onPermissionGuardReady(() => {
